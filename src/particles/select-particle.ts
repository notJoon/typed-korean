 ...
 * @example 은는<"사과"> // "는"
 */
export type 은는<W extends string> =
 ...
 * @example 이가<"사과"> // "가"
 */
export type 이가<W extends string> =
  HasBatchim<W> extends true
    ? "이"
    : HasBatchim<W> extends false
      ? "가"
 ...
 * @example 을를<"사과"> // "를"
 */
export type 을를<W extends string> =
  HasBatchim<W> extends true
    ? "을"
    : HasBatchim<W> extends false
      ? "를"
 ...
 * @example 과와<"사과"> // "와"
 */
export type 과와<W extends string> =
  HasBatchim<W> extends true
    ? "과"
    : HasBatchim<W> extends false
      ? "와"
 ...
 */
type SelectAlternating<W extends string, R extends AlternatingParticleRole> =
  HasBatchim<W> extends true
